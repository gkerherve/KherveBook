...
class HistoryDialog(QDialog):
    """Browse the commits behind the current notebook, visualise the
    ...
    def __init__(self, repo_dir: Path, parent: QWidget | None = None,
        ...
        self._restore_btn.setToolTip(
            "Roll the notebook back to the selected commit. "
    ...
    def _refresh_after_branch_change(self) -> None:
        ...
        if self._commits:
            self._table.setCurrentCell(0, 0)
        # Reload the notebook in the editor if branch changed.
    ...
    def _on_restore_clicked(self) -> None:
        ...
        QMessageBox.information(
            self, "Restored",
            f"The notebook was rolled back to commit "
