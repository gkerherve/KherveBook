"""Connect your notebook to a cloud git service (GitHub, GitLab, etc.)
...
class RemoteDialog(QDialog):
    """Guide the user through connecting their notebook to a cloud
    ...
    def __init__(self, repo_dir: Path, parent: QWidget | None = None) -> None:
        ...
        if existing:
            intro_html = (
                "<b>Your notebook is connected to:</b>"
            )
        else:
            intro_html = (
                "<b>Connect your notebook to a cloud service</b><br><br>"
                "This lets you:<br>"
                "&nbsp;&nbsp;• <b>Back up</b> your work online automatically<br>"
                "&nbsp;&nbsp;• <b>Share</b> your notebook with collaborators<br>"
                ...
                "<code>https://github.com/you/my-notebook.git</code>)<br>"
    ...
    def _add(self) -> None:
        ...
        url, ok = QInputDialog.getText(
            ...
            "Examples:\n"
            "  https://github.com/username/my-notebook.git\n"
            "  git@github.com:username/my-notebook.git")
        url = url.strip()
        ...
        QMessageBox.information(
            self, "Connected!",
            f"Your notebook is now linked to:\n\n  {url}\n\n"
            "From now on, every time you save your notebook it will "
